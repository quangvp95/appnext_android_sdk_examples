...
import com.example.appnextapplication.R;

import java.util.ArrayList;

public class InFeedExample2 extends ComponentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nativeAd.setAdListener(new NativeAdListener() {
            ...
            public void onAdLoaded(NativeAd nativeAd, AppnextAdCreativeType appnextAdCreativeType) {
                ...
                nativeAd.downloadAndDisplayImage(InFeedExample2.this, imageView, nativeAd.getIconURL());
